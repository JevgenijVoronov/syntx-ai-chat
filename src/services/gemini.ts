...
const DEFAULT_PROMPT = `Ты — знаменитый музыкант. Отвечай в образе этого персонажа`

// Mock-ответы для тестирования (когда API недоступен)
...
export async function sendMessageToGemini(
  ...
  const systemPrompt = CELEBRITY_PROMPTS[celebrityName] ?? DEFAULT_PROMPT
